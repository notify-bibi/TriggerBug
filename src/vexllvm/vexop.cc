...
CASE_OP(CmpLE64Fx2)
CASE_OP(CmpUN64Fx2)
//CASE_OP(RecipEst64Fx2)
CASE_OP(Sqrt64Fx2)
//CASE_OP(RSqrtEst64Fx2)
CASE_OP(Add64F0x2)
CASE_OP(Sub64F0x2)
CASE_OP(Mul64F0x2)
CASE_OP(Div64F0x2)
...
CASE_OP(CmpGT32Fx2)
CASE_OP(CmpGE32Fx2)
CASE_OP(RecipEst32Fx2)
CASE_OP(RecipStep32Fx2)
CASE_OP(RSqrtEst32Fx2)
CASE_OP(RSqrtStep32Fx2)
CASE_OP(Neg32Fx2)
CASE_OP(Abs32Fx2)
CASE_OP(CmpNEZ8x8)
CASE_OP(CmpNEZ16x4)
...
CASE_OP(QSal64x1)
#if 0
CASE_OP(QShlNsat8Sx8)
CASE_OP(QShlNsat16Sx4)
CASE_OP(QShlNsat32Sx2)
CASE_OP(QShlNsat64Sx1)
CASE_OP(QShlNsat8x8)
CASE_OP(QShlNsat16x4)
CASE_OP(QShlNsat32x2)
CASE_OP(QShlNsat64x1)
CASE_OP(QSalNsat8x8)
CASE_OP(QSalNsat16x4)
CASE_OP(QSalNsat32x2)
CASE_OP(QSalNsat64x1)
#endif
...
EMIT_HELPER_UNOP_VEC(Cls32x4, get_vt(32, 4), "vexop_cls32")
EMIT_HELPER_UNOP_VEC(Cls32x2, get_vt(32, 2), "vexop_cls32")

...
#include "instopt/utils/FileSystem.h"
#include "instopt/utils/ABI.h"
#include "instopt/utils/VectorType.h"
#include "instopt/utils/ToolOutputFile.h"
#include "instopt/utils/ArchName.h"
#include "instopt/utils/CallSite.h"
...
bool StoreModuleIRToFile(llvm::Module *module, std::string_view file_name_,
  ...
  llvm::raw_fd_ostream dest(file_name.c_str(), ec, llvm::sys::fs::OpenFlags::OF_Text);
#else

...
/*patch start{*/
   case S390X_GUEST_OFFSET(guest_IA)+0x7 : 
   case S390X_GUEST_OFFSET(guest_IA)+0x6 : 
   case S390X_GUEST_OFFSET(guest_IA)+0x5 : 
   case S390X_GUEST_OFFSET(guest_IA)+0x4 : 
   case S390X_GUEST_OFFSET(guest_IA)+0x3 : 
   case S390X_GUEST_OFFSET(guest_IA)+0x2 : 
   case S390X_GUEST_OFFSET(guest_IA)+0x1 : 
//   case S390X_GUEST_OFFSET(guest_IA)+1      ... S390X_GUEST_OFFSET(guest_IA)+7:

/*patched }end*/
/*patch start{*/
   case S390X_GUEST_OFFSET(guest_CC_OP)+0x7 : 
   case S390X_GUEST_OFFSET(guest_CC_OP)+0x6 : 
   case S390X_GUEST_OFFSET(guest_CC_OP)+0x5 : 
   case S390X_GUEST_OFFSET(guest_CC_OP)+0x4 : 
   case S390X_GUEST_OFFSET(guest_CC_OP)+0x3 : 
   case S390X_GUEST_OFFSET(guest_CC_OP)+0x2 : 
   case S390X_GUEST_OFFSET(guest_CC_OP)+0x1 : 
//   case S390X_GUEST_OFFSET(guest_CC_OP)+1   ... S390X_GUEST_OFFSET(guest_CC_OP)+7:

/*patched }end*/
/*patch start{*/
   case S390X_GUEST_OFFSET(guest_CC_DEP1)+0x7 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP1)+0x6 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP1)+0x5 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP1)+0x4 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP1)+0x3 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP1)+0x2 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP1)+0x1 : 
//   case S390X_GUEST_OFFSET(guest_CC_DEP1)+1 ... S390X_GUEST_OFFSET(guest_CC_DEP1)+7:

/*patched }end*/
/*patch start{*/
   case S390X_GUEST_OFFSET(guest_CC_DEP2)+0x7 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP2)+0x6 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP2)+0x5 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP2)+0x4 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP2)+0x3 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP2)+0x2 : 
   case S390X_GUEST_OFFSET(guest_CC_DEP2)+0x1 : 
//   case S390X_GUEST_OFFSET(guest_CC_DEP2)+1 ... S390X_GUEST_OFFSET(guest_CC_DEP2)+7:

/*patched }end*/
/*patch start{*/
   case S390X_GUEST_OFFSET(guest_CC_NDEP)+0x7 : 
   case S390X_GUEST_OFFSET(guest_CC_NDEP)+0x6 : 
   case S390X_GUEST_OFFSET(guest_CC_NDEP)+0x5 : 
   case S390X_GUEST_OFFSET(guest_CC_NDEP)+0x4 : 
   case S390X_GUEST_OFFSET(guest_CC_NDEP)+0x3 : 
   case S390X_GUEST_OFFSET(guest_CC_NDEP)+0x2 : 
   case S390X_GUEST_OFFSET(guest_CC_NDEP)+0x1 : 
//   case S390X_GUEST_OFFSET(guest_CC_NDEP)+1 ... S390X_GUEST_OFFSET(guest_CC_NDEP)+7:

/*patched }end*/
/*patch start{*/
   case S390X_GUEST_OFFSET(guest_SYSNO)+0x7 : 
   case S390X_GUEST_OFFSET(guest_SYSNO)+0x6 : 
   case S390X_GUEST_OFFSET(guest_SYSNO)+0x5 : 
   case S390X_GUEST_OFFSET(guest_SYSNO)+0x4 : 
   case S390X_GUEST_OFFSET(guest_SYSNO)+0x3 : 
   case S390X_GUEST_OFFSET(guest_SYSNO)+0x2 : 
   case S390X_GUEST_OFFSET(guest_SYSNO)+0x1 : 
...
/*patch start{*/
   case S390X_GUEST_OFFSET(guest_counter)+0x3 : 
   case S390X_GUEST_OFFSET(guest_counter)+0x2 : 
   case S390X_GUEST_OFFSET(guest_counter)+0x1 : 
//   case S390X_GUEST_OFFSET(guest_counter)+1 ... S390X_GUEST_OFFSET(guest_counter)+3:

/*patched }end*/
/*patch start{*/
   case S390X_GUEST_OFFSET(guest_counter)+0x7 : 
   case S390X_GUEST_OFFSET(guest_counter)+0x6 : 
   case S390X_GUEST_OFFSET(guest_counter)+0x5 : 
...
s390_isel_stmt(ISelEnv *env, IRStmt *stmt)
{
   ...
   case Ist_Put: {
      ...
      /* Detect updates to certain guest registers. We track the contents
         of those registers as long long as they contain constants. If the new

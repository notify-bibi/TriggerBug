...
static inline IRExpr *get_fpr_dw0(UInt);
static inline void    put_fpr_dw0(UInt, IRExpr *);
static inline IRExpr *get_dpr_dw0(UInt);
static inline void    put_dpr_dw0(UInt, IRExpr *);
...
{
   // As long long as we dont support SPM, lets just assume 0 as program mask

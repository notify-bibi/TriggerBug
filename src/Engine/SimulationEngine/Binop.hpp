...
dosymbol:
	...
	case Iop_DivModS64to32: {
		...
		return Vns(m_ctx,
			Z3_mk_concat(m_ctx,
			(a % beichushu).extract(31, 0) - ite(lt(a, 0), b, Vns(m_ctx, 0u, 32)),
    ...
    case Iop_CmpEQ8x32: {
        return Vns(m_ctx, _mm256_cmpeq_epi8(a, b)); 
    }
    case Iop_CmpEQ16x16: {
        return Vns(m_ctx, _mm256_cmpeq_epi16(a, b)); 
    }
    case Iop_CmpEQ32x8: {
        return Vns(m_ctx, _mm256_cmpeq_epi32(a, b)); 
    }
    case Iop_CmpEQ64x4: {
        return Vns(m_ctx, _mm256_cmpeq_epi64(a, b)); 
    }

...
public:
    ...
    template<typename T>
    inline Vns(context const &ctx, T v) : Vns((Z3_context)ctx, v) {};
    ...
    template<typename T>
    inline Vns(context const &ctx, T v, UShort size) : 
    ...
    inline Vns(context const &ctx, Z3_ast ast) :
        Vns((Z3_context) ctx,  ast) {};

    inline Vns(context const &ctx, Z3_ast ast, no_inc no) :
    ...
    inline Vns(context const &ctx, Z3_ast ast, UShort n) : 
        Vns((Z3_context)ctx,  ast,  n) {};

    inline Vns(context const &ctx, Z3_ast ast, UShort n, no_inc  no) : 
        Vns((Z3_context)ctx, ast, n, no) {};

    inline Vns(expr const &exp, UShort n) : 
    ...
    inline Vns(context const &ctx, bool tf) :
...
private:
    ...
    operator expr&() = delete;
    operator expr() const = delete;
    operator expr&() const = delete;
    operator const expr() = delete;
    operator const expr &() = delete;
    operator const expr()const = delete;
    operator const expr &()const = delete;
    ...
    operator context&() const = delete;
    operator const context()const = delete;
    operator const context&()const = delete;
...
static inline std::ostream & operator<<(std::ostream & out, Vns const& n) {

...
namespace TR {
    ...
    class MEM : public TRMem::mapping<PAGE> {
        friend class State<ADDR>;
        template<typename _> friend class StateMEM;
        friend class DMEM;
    public:
        class Itaddress {
        private:
    ...
    private:
        ...
        MEM(vctx_base const& vctxb, z3::solver& s, z3::vcontext& ctx, PML4T** cr3, Int _user, Bool _need_record) :
            m_vctx(vctxb),
    ...
    public:
        MEM(vctx_base& vctxb, z3::solver& so, z3::vcontext& ctx, Bool _need_record);

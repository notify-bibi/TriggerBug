...
namespace TR {
    ...
    UInt vex_info::_gMaxThreadsNum() {
        UInt    mMaxThreadsNum = 8;
        ...
        return mMaxThreadsNum;
    }

    vex_info::vex_info(const char* filename) :
        ...
        doc_debug(nullptr),
        guest_system(TR::unknowSystem),
        guest(VexArch_INVALID),
        MemoryDumpPath("你没有这个文件"),
        MaxThreadsNum(_gMaxThreadsNum()),
        traceflags(0),
        m_pool(MaxThreadsNum)
    {

...
public:
    ...
    TR::State<Addr64>& m_state;
public:
    //VexGuestAMD64State() :VexGuestAMD64State(*(TR::State<Addr64>*)g_state){}
	VexGuestAMD64State(TR::State<Addr64>&s):
        m_state(s),
    ...
    inline operator TR::Register<REGISTER_LEN> &() {
        return m_state.regs;
    }

    inline operator TR::MEM<Addr64>&() {
        return m_state.mem;
    }
};
...
public:
    //VexGuestX86State() :VexGuestX86State(*(TR::State<Addr32>*)g_state) {}
    VexGuestX86State(TR::State<Addr32>& s):
        host_EvC_FAILADDR   (s, 0  ),
...
//TriggerBug Guest Layout
    ...
    public:
        ...
        public:
            ...
            Bits(TR::State<Addr32>& state, Addr32 base) :
        ...
        public:
            ...
            Words(TR::State<Addr32>& state, Addr32 base) :
        ...
        public:
            Words Words;
            Bits Bits;
            LdtEnt(TR::State<Addr32>& state, Addr32 base) :
                Words(state, base),
                Bits(state, base)
            {
            }
        ...
        LdtEnt LdtEnt;
        VexGuestX86SegDescr(TR::State<Addr32>& state, Addr32 base) :
            LdtEnt(state, base)
        {

        }
        /*VexGuestX86SegDescr(Addr32 base) :
            LdtEnt(*(TR::State<Addr32>*)g_state, base)
        {

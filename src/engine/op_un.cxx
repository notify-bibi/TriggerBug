...
Vns Kernel::T_Unop(context &m_ctx, IROp op, Vns const& a) {
    //a.tostr();
    if (a.symbolic())
    {
        switch (op) {
        ...
        case Iop_NotV256:return Vns(a, _mm256_xor_si256(a, _mm256_set1_epi64x(-1)));
        case Iop_NotV128:return Vns(a, _mm_xor_si128(a, _mm_set1_epi64x(-1)));

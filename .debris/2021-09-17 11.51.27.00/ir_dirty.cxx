...
#include "../helper/z3_target_call.h"
...
namespace TR {
    ...
    public:
        ...
        irsb_chunk translate_front(HWord /*dirty/guest_addr*/) override;
    ...
    irsb_chunk EmuEnvHost::translate_front(HWord ea)
    {
        VexRegisterUpdates pxControl;
        VexTranslateResult res;


        irsb_chunk cache_irsb = host_irsb_cache_find(m_host_irsb_cache, ea);
